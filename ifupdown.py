...
INTERFACES = ['usb0','usb1','usb2','usb3','usb4','usb5']
ACTIONS = ['up','down']
### CHANGE HERE TO YOUR INTERFACE ADDRESS
MAIN_NETWORK = '192.168.1'
MAIN_NETWORK_POSTFIX = '17'

def interface_ip(name, timeout=45):
   ip = ''
   try:
...
def interface_up(name):
   ...
   ip_split = ip.split(".")
   if ip_split[0] == "172" and ip_split[1] == "30":
      if ip_split[3] != "101":
         subprocess.getoutput("ip address add {}.101/24 dev {}".format(ip[:8],name))
   return 0
